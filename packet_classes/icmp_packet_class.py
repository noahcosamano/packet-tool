...
from field_validation import validate_ipv4, validate_mac, validate_payload


class ICMP_Packet(Packetv4):
    """
    ...
    __slots__ = ["src_ipv4", "dst_mac", "src_mac", "payload"]
    ...
    def __init__(
        ...
        super().__init__(protocol="icmp", dst_ipv4=dst_ipv4, num_pkts=num_pkts)
